...
class TestGraph:
    class Test_Top_Words_Bar_Graph:
        ...
        def test_graph_bar_top_words_less_than_N(self, mock_typer, runner):
            ...
            assert result.exit_code == 0
            assert (
                "Not enough words found. Showing graph for available words only"
                in result.stdout
            )
    ...
    class Test_Top_Tags_Bar_Graph:
        ...
        def test_graph_top_tags_bar_less_than_N(self, mock_typer, runner):
            ...
            assert result.exit_code == 0
            assert (
                "Not enough tags found. Showing graph for available tags only."
                in result.stdout
            )
    ...
    class Test_Top_Tags_Pie_Chart:
        ...
        def test_graph_top_tags_pie_less_than_N(self, mock_typer, runner):
            ...
            assert result.exit_code == 0
            assert (
                "Not enough tags found. Showing Pie Chart for available tags only."
                in result.stdout
            )
    ...
    class Test_LearnVsMaster:
        ...
        def test_graph_learnVsMaster(self, mock_typer, runner):
            ...
            assert result.exit_code == 0
            assert (
                "Displaying Stacked Bar Graph of mastered vs learning words"
                in result.stdout
            )
    ...
    class Test_Lookup_History:
        ...
        def test_graph_lookup_history_week(self, mock_typer, runner):
            ...
            assert result.exit_code == 0
            assert (
                "Displaying Bar Graph of weekly word lookup distribution"
                in result.stdout
            )
        ...
        def test_graph_lookup_history_month(self, mock_typer, runner):
            ...
            assert result.exit_code == 0
            assert (
                "Displaying Bar Graph of monthly word lookup distribution"
                in result.stdout
            )
    ...
    class Test_Word_Category:
        ...
        def test_graph_word_category(self, mock_typer, runner):
            ...
            assert result.exit_code == 0
            assert (
                "Displaying Bar Graph of word distribution by category" in result.stdout
            )
