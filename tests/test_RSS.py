...
class TestRSS:
    ...
    def test_add_feed(self, runner):
        result = runner.invoke(
            app,
            ["rss", "-a", "https://www.tor.com/series/reading-the-wheel-of-time/feed/"],
        )
    ...
    def test_add_feed_invalid_URL(self, runner):
        result = runner.invoke(
            ...
            [
                "rss",
                "-a",
                "https://www.tor.com/series/reading-the-wheel-of-time/feed/asdsadsad",
            ],
        )
        assert result.exit_code == 0
